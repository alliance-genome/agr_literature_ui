...
const TopicEntityTable = () => {
  ...
  // }));
    ...
    { headerName: "Entity ID Validation", field: "entity_id_validation", id: 13 , checked: false},
    { headerName: "Date Created", field: "date_created", id: 14, checked: true},
    { headerName: "Updated By", field: "updated_by", id: 15, checked: false },
    { headerName: "Date Updated", field: "date_updated", id: 16, checked: true},
    { headerName: "Author Response", field: "validation_by_author", id: 17, checked: false },
    { headerName: "Validation By Professional Biocurator", field: "validation_by_professional_biocurator", id: 18, checked: false },
    { headerName: "Display Tag", field: "display_tag_name", id: 19, checked: false},
    { headerName: "Source Secondary Data Provider", field: "topic_entity_tag_source.secondary_data_provider_abbreviation", id: 20, checked: true },
    { headerName: "Source Data Provider", field: "topic_entity_tag_source.data_provider", id: 21, checked: false },
    { headerName: "Source Evidence Assertion", field: "topic_entity_tag_source.source_evidence_assertion_name" , id: 22, checked: false},
    { headerName: "Source Method", field: "topic_entity_tag_source.source_method", id: 23, checked: false },
    { headerName: "Source Validation Type", field: "topic_entity_tag_source.validation_type", id: 24, checked: false },
    { headerName: "Source Description", field: "topic_entity_tag_source.description" , id: 25, checked: false},
  ...
  let itemsInitSGD=[
    ...
    { headerName: "Author Response", field: "validation_by_author", id: 17, checked: false },
    { headerName: "Validation By Professional Biocurator", field: "validation_by_professional_biocurator", id: 18, checked: false },
    { headerName: "Display Tag", field: "display_tag_name", id: 19, checked: true},
    { headerName: "Source Secondary Data Provider", field: "topic_entity_tag_source.secondary_data_provider_abbreviation", id: 20, checked: false },
    { headerName: "Source Data Provider", field: "topic_entity_tag_source.data_provider", id: 21, checked: false },
    { headerName: "Source Evidence Assertion", field: "topic_entity_tag_source.source_evidence_assertion_name" , id: 22, checked: false},
    { headerName: "Source Method", field: "topic_entity_tag_source.source_method", id: 23, checked: false },
    { headerName: "Source Validation Type", field: "topic_entity_tag_source.validation_type", id: 24, checked: false },
