...
export const RENAME_FACETS = {
    ...
    "has_reference_emails": "Email extraction",
    "datePubmedAdded": {
...
export const FACETS_CATEGORIES_WITH_FACETS = {
    ...
    "Workflow Tags": ["file_workflow", "reference_classification", "entity_extraction", "manual_indexing", "curation_classification", "community_curation", "has_reference_emails"], 
        ...
        <div className="facet-container">
            {facetsToInclude.map(facetToInclude => {
                ...
                if (!['topics', 'confidence_levels', 'confidence_scores', 'source_methods', 'source_evidence_assertions', 'data_novelty',
		                ...
		                'entity_extraction', 'curation_classification', 'community_curation', 'has_reference_emails'].includes(key)) {
                    key = key + '.keyword';
                }
