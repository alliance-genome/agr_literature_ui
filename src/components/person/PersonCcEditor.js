        ...
        <Card.Body>
          ...
          <Row className="mb-2">
            <Col md={6}>
              ...
              <Form.Control as="select" defaultValue={p.privacy ?? 'hide_email'}>
                <option value="show_all">show_all</option>
                <option value="logged_in_only">logged_in_only</option>
                <option value="fully_hidden">fully_hidden</option>
                <option value="hide_email">hide_email</option>
              </Form.Control>
            </Col>
          </Row>
          <Row className="mb-2">
