...
//   console.log(e);
  return {
    type: 'MOCK1_CHANGE_FIELD_MOD_ASSOCIATION_REFERENCE_JSON',	// this doesn't do anything yet
    payload: {
      field: e.target.id,
      checked: e.target.checked,
      value: e.target.value
...
export const biblioMock1QueryReferenceCurie = (referenceCurie) => dispatch => {
...
//     history.push("/Biblio");	// value hasn't been set in store yet
    ...
    dispatch({
      type: 'BIBLIOMOCK1_GET_REFERENCE_CURIE',
